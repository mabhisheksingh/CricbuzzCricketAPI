...
public class CustomLogger {
    ...
    public static void logInRequest(ServerRequest sr){
        //[org.springframework.web.reactive.function.server.RouterFunctions.uriTemplateVariables, org.springframework.web.reactive.HandlerMapping.bestMatchingHandler,
        // org.springframework.web.reactive.HandlerMapping.bestMatchingPattern, org.springframework.web.reactive.function.server.RouterFunctions.request,
        ...
        logger.info("Id: {}, URL PATH {}, Http headers {}, path variables {}, calling method  {}",sr.attributes().get("org.springframework.web.server.ServerWebExchange.LOG_ID"),sr.path(),sr.headers(), sr.pathVariables(), sr.method() );
    }
